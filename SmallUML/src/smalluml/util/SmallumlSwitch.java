...
public class SmallumlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SmallumlPackage.UNLIMITED_NATURAL: {
				UnlimitedNatural unlimitedNatural = (UnlimitedNatural)theEObject;
				T result = caseUnlimitedNatural(unlimitedNatural);
				if (result == null) result = caseType(unlimitedNatural);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseBoolean(smalluml.Boolean object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseUnlimitedNatural(UnlimitedNatural object) {
		return null;
	}
